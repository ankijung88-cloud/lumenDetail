  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto text-center z-10">
        ...
        {/* Top Tag Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-950/60 border border-cyan-500/30 text-cyan-300 text-xs font-semibold mb-8 shadow-inner backdrop-blur-md animate-bounce">
          <Sparkles className="w-3.5 h-3.5 text-cyan-400" />
          <span>찾아가는 1:1 프리미엄 개인 출장 디테일링</span>
          <span className="w-1.5 h-1.5 rounded-full bg-cyan-400" />
          <span className="text-slate-400 font-normal">수도권 전 지역</span>
        </div>
        ...
        {/* Subtitle */}
        <p className="max-w-2xl mx-auto text-slate-300 text-base sm:text-lg mb-10 leading-relaxed font-normal">
          샵에 차를 맡기고 기다리는 번거로움 없이, <strong className="text-cyan-300 font-semibold">클리어층을 지키는 수성 듀얼 광택</strong>과 
          <strong className="text-white font-semibold"> 9H 프리미엄 세라믹 코팅</strong>을 고객님이 계신 곳에서 1:1 맞춤 시공해 드립니다.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button
            onClick={onBookClick}
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 via-cyan-400 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold text-base shadow-xl shadow-cyan-500/30 flex items-center justify-center gap-2.5 transition-all hover:scale-105 active:scale-95 group"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-xl bg-slate-900/80 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:border-slate-500 font-semibold text-base flex items-center justify-center gap-2 transition-all"
          >
