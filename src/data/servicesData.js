...
export const PRICING_DATA = {
  ...
  packages: [
    ...
    {
      id: 'premium_coating',
      name: '프리미엄 광택 + 9H 유리막 코팅',
      desc: '신차급 광택 + 9H 세라믹 2코트 + 전면 유막/발수',
      recommended: true,
      badge: '가장 인기 있는 시공',
      prices: {
        compact: 420000,
      ...
      includes: [
        ...
        '풀 마스킹 & 3단계 수성 듀얼 광택',
        '알코올 100% 탈지 공정',
        '9H 최고급 세라믹 유리막 코팅 (1년 보증)',
        '전면 유리 유막제거 & 초발수 코팅 무료 시공',
        '실내 피톤치드 연무 살균 서비스'
      ]
    },
    {
      ...
      desc: '외장 수성광택 + 유리막 + 실내 스팀 크리닝 + 전체 유리 발수',
      recommended: false,
      badge: '토탈 케어 종결',
      prices: {
        compact: 650000,
      ...
      includes: [
        ...
        '휠 세라믹 코팅 & 플라스틱 트림 케어',
        '1년 시공 보증서 발급 & 보증 AS 케어'
      ]
    }
  ],
  singleServices: [
    { name: '본넷(후드) 집중 수성 광택 (단품)', priceRange: '8만 ~ 13만원' },
    { name: '도어(문짝 1판) 흠집 & 스월 케어', priceRange: '5만 ~ 9만원' },
    { name: '앞/뒤 범퍼(1개소) 코너 쓸림 광택', priceRange: '7만 ~ 12만원' },
    { name: '앞/뒤 휀다(1판) 및 필러 집중 케어', priceRange: '5만 ~ 8만원' },
    { name: '트렁크 리드 / 루프 상판 집중 케어', priceRange: '7만 ~ 12만원' },
    { name: '전면 유리 유막제거 + 초발수 코팅', priceRange: '6만 ~ 9만원' },
    { name: '실내 스팀 딥크리닝 (단품)', priceRange: '18만 ~ 30만원' },
    { name: '헤드라이트 황변 클리닝 (양쪽 1세트)', priceRange: '8만 ~ 12만원' }
  ],
  travelZones: {
    hub: '인천 청라국제도시',
...
export const FAQS = [
  ...
  },
  {
    ...
    a: '차종 및 도장 상태에 따라 상이하나, 베이직 광택은 3~4시간, 프리미엄 광택+유리막 코팅은 5~6시간, 올인원 VIP 패키지는 약 6~8시간 정도 소요됩니다.'
  },
  {
